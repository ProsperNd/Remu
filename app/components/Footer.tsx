    ...
    <footer className="bg-gray-900 text-white pt-12 pb-8">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* About */}
          <div>
            <h3 className="text-2xl font-bold mb-4">Remu</h3>
            <p className="text-gray-400 mb-4">
              Discover the best products at unbeatable prices. Our e-commerce platform offers a wide range of products to meet all your needs.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                <MapPinIcon className="h-6 w-6 text-primary mr-2 flex-shrink-0" />
              ...
              <li className="flex items-center">
                <PhoneIcon className="h-5 w-5 text-primary mr-2 flex-shrink-0" />
                <span className="text-gray-400">+1 (555) 123-4567</span>
              </li>
              <li className="flex items-center">
                <EnvelopeIcon className="h-5 w-5 text-primary mr-2 flex-shrink-0" />
                <span className="text-gray-400">support@remu.com</span>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <form onSubmit={handleNewsletterSubmit}>
              ...
              <button
                type="submit"
                  className="bg-primary hover:bg-primary-dark text-white px-4 py-2 rounded-r-lg transition duration-300"
              >
                Subscribe
              </button>
              </div>
        ...
        <div className="border-t border-gray-800 mt-10 pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              &copy; {currentYear} Remu. All rights reserved.
            </p>
